...
heroImage.src = './imgs/pikachu.jpg';
...
dragonImage.src = './imgs/raiochu.gif';
...
const reset = function(){
    ...
    //posiciona o dragao aleiatoriamente na tela
 ...
 const update = function(modifier){
     ...
     if (37 in keysDown){//pressionando seta pra esquerda
        hero.x -= hero.speed * modifier;
    }
    if(39 in keysDown){//pressionando seta para direita
        hero.x += hero.speed * modifier;
    }
